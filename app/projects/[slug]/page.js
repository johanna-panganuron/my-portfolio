...
// • Customer notifications (Email)`,
    technologies: ['Vue', 'VITE', 'Node.js', 'Express.js', 'MySQL', 'JWT', 'OAuth', 'CSS'],
  ...
  'cpc-voting': {
    title: 'CPC Voting',
    description: 'The CPC Voting System is a secure web-based voting platform developed for Cordova Public College to modernize the school election process. It enables students to vote online through a verified account while administrators manage candidates, elections, and results. The system ensures transparency and accuracy through role-based access, real-time vote counting, and secure data handling.',
    fullDescription: `The CPC Voting System is a secure digital voting platform designed for educational institutions. Features include:
...
• Responsive design for mobile and desktop`,
    ...
    screenshots: [
      '/images/projects/task-tracker.png',
